...
public class Stories : IPalette {
    ...
    public static Color _lowlight = RGB.rgb(108, 91, 123);
    public static Color _player = RGB.rgb(192, 108, 132);
    ...
    public Color lowlight { get { return _lowlight; } }
...
public class Thumbelina : IPalette {
    ...
    public static Color _lowlight = RGB.rgb(188, 162, 151);
...
public class BathHouse : IPalette {
    ...
    public static Color _lowlight = RGB.rgb(191, 216, 173);
...
public class LoversInJapan : IPalette {
    ...
    public static Color _lowlight = RGB.rgb(214, 129, 137);
